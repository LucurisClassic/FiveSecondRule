    ...
    function(self, event, arg1, ...)
        if event == "PLAYER_LOGIN" then
            if not OptionsPanelFrame.optionsPanel then
                ...
                category, layout = Settings.RegisterCanvasLayoutCategory(OptionsPanelFrame.optionsPanel, OptionsPanelFrame.optionsPanel.name, OptionsPanelFrame.optionsPanel.name);
